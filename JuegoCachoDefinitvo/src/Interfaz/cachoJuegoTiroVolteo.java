...
public class cachoJuegoTiroVolteo extends javax.swing.JFrame {
//inicio de la clase
   ...
   Jugadas miJ ;//creamos un objeto tipo jugada
     public cachoJuegoTiroVolteo(String nombre) 
    {
        ...
        jugM=new JugadorMaquina("Jane",0,0); //se declara un objeto tipo maquina
        etiquetaNombreJug.setText(nombre);//colocamos el nombre en pantalla
        etiquetaNombreJug1.setText("Jane");//colocamos el nombre de la maquina en pantalla
        bloquearNumDados();//se bloquean los botones de los dados
        bloquearJugadas();
        anularEtiquetasFinal();
   
    }
    public cachoJuegoTiroVolteo(int a, String nombre1,String nombre2)//constructor de la clase sobrecargado 
    {
        ...
        turno=getTurno(2);//etiqueta turno
          ...
          bloquearNumDados();//bloquea los botones de los dados para interactuar con ellos
    ...
    private void initComponents() {
        ...
        Instruccion.setFont(new java.awt.Font("xscale", 1, 18)); // NOI18N
        Instruccion.setForeground(new java.awt.Color(255, 255, 255));
        Instruccion.setText("poR FAVOR SELECCIONE UN DADO PARA VOLTEARLO");
        getContentPane().add(Instruccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 400, 450, 40));
    ...
    private void botonDado2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonDado2ActionPerformed
        ...
        miJuego.voltearDado2();//el boton principalmente voltea el dado
        D2=miJuego.devolverDado2();//obtiene D2=miJuego.devolverDado2();
        mostrarNumeroDados();//muestra los nuevos numeros en los dados
        mostrarDados( D1,D2,D3,D4,D5 );//mandamos los dados String al metodo mostrar Dados
        miJ.reestablecerJugadas(miJuego.devolverTodos());//mandamos nuevos valores y muestra las nuevas jugadas
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cachoJuegoTiroVolteo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new cachoJuegoTiroVolteo(0,"","").setVisible(true);
    ...
    private void bloquearNumDados()
    {
        botonDado1.setEnabled(false);//oculta D1 en el boton dado1
        botonDado2.setEnabled(false);// oculta d2 en el boton dado2
        botonDado3.setEnabled(false);//oculta d3 en el boton dado3
        botonDado4.setEnabled(false);//oculta d4 en el boton dado4
        botonDado5.setEnabled(false);//oculta d5 en el boton dado5
    }
    ...
    {//metodo de acciones al presionar el boton tirar dado  
        botonTirar.setEnabled(false);//se bloquea el boton 
        InstruccionDeJugadas.setVisible(true);//esta etiqueta se hace visible
        ...
        mostrarNumeroDados();//se llama a metodo mostrar num dados
        
        mostrarDados( D1,D2,D3,D4,D5 );//mandamos los dados String al metodo mostrar Dados
        bloquearJugadas();//Bloquea todas las jugadas
        jug1.pidoPuntaje();//invocamos al metodo pidoPuntaje del jugador 1
        jug2.pidoPuntaje();//invocamos al metodo pidoPuntaje del jugador 2
        habilitarNumDados();//llama metodo que nuevamente hace accesible a los botones de los dados
    }
    ...
    private void lanzamientoUnJugador()
    {
       ...
       {botonTirar.setEnabled(false);//se bloquea el boton 
        ...
        bloquearJugadas();//Bloquea todas las jugadas
        jug1.pidoPuntaje();//invocamos al metodo pidoPuntaje del jugador 1
        jugM.pidoPuntaje();//invocamos al metodo pidoPuntaje del jugador 2
        habilitarNumDados();//llama metodo que nuevamente hace accesible a los botones de los dados
       }
